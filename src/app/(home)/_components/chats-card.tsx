...
export async function ChatsCard() {
  ...
  return (
    <div className="col-span-12 rounded-[10px] bg-white py-6 shadow-1 dark:bg-gray-dark dark:shadow-card xl:col-span-4">
      <h2 className="mb-5.5 px-4 sm:px-7.5 text-body-2xlg font-bold text-dark dark:text-white">
        Chats
      </h2>
      ...
      <ul>
        {data.map((chat, key) => (
          <li key={key}>
            <Link
              href="/"
              className="flex items-center gap-3 sm:gap-4.5 px-4 sm:px-7.5 py-3 outline-none hover:bg-gray-2 focus-visible:bg-gray-2 dark:hover:bg-dark-2 dark:focus-visible:bg-dark-2"
            >
              <div className="relative shrink-0">
                <Image
                  ...
                  width={56}
                  height={56}
                  className="size-10 sm:size-14 rounded-full object-cover"
