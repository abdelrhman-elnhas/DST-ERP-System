...
export async function PaymentsOverview({
  ...
  return (
    <div
      className={cn(
        "grid gap-2 rounded-[10px] bg-white px-4 pb-4 pt-5 sm:px-7.5 sm:pb-6 sm:pt-7.5 shadow-1 dark:bg-gray-dark dark:shadow-card",
        className,
      )}
    >
      ...
      <dl className="grid divide-stroke text-center dark:divide-dark-3 sm:grid-cols-2 sm:divide-x [&>div]:flex [&>div]:flex-col-reverse [&>div]:gap-1">
        <div className="max-sm:mb-3 max-sm:border-b max-sm:border-stroke max-sm:pb-3 max-sm:dark:border-dark-3">
